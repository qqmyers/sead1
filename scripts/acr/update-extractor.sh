...
wget -q -O Extractor.gtk.linux.x86_64.zip https://opensource.ncsa.illinois.edu/bamboo/browse/MMDB-EX0/latest/artifact/shared/extractors/edu.illinois.ncsa.medici.extractor.site_1.2.100-eclipse.feature/Extractor.gtk.linux.x86_64.zip
...
./ExtractionServer -application org.eclipse.equinox.p2.director \
	-r https://opensource.ncsa.illinois.edu/bamboo/browse/MMDB-EX0/latest/artifact/shared/site.p2/edu.illinois.ncsa.medici.extractor.site_1.2.100-eclipse.feature/site.p2 \

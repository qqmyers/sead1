...
<link rel="shortcut icon" href="http://seadwp.sites.uofmhosting.net/wp-content/uploads/2014/06/favicon1.png" type="image/x-icon">		<style type="text/css"> blockquote { border-left: 3px solid #f3882a; }
			...
			a { color: #f3882a; }
			#site-title a:hover { color: #f3882a; }
			.main-navigation ul li.current_page_item a, .main-navigation ul li:hover > a { color: #f3882a; }
			.main-navigation ul li ul { border-top: 1px solid #f3882a; }
			.main-navigation ul li ul li a:hover, .main-navigation ul li ul li:hover > a, .main-navigation ul li.current-menu-item ul li a:hover { color: #f3882a; }
			.site-header .menu-toggle:hover { background: #f3882a; }
			.main-small-navigation li:hover { background: #f3882a; }
			.main-small-navigation ul > .current_page_item, .main-small-navigation ul > .current-menu-item { background: #f3882a; }
			.main-navigation a:hover, .main-navigation ul li.current-menu-item a, .main-navigation ul li.current_page_ancestor a, .main-navigation ul li.current-menu-ancestor a, .main-navigation ul li.current_page_item a, .main-navigation ul li:hover > a  { color: #f3882a; }
			.small-menu a:hover, .small-menu ul li.current-menu-item a, .small-menu ul li.current_page_ancestor a, .small-menu ul li.current-menu-ancestor a, .small-menu ul li.current_page_item a, .small-menu ul li:hover > a { color: #f3882a; }
			#featured-slider .slider-read-more-button { background-color: #f3882a; }
			#controllers a:hover, #controllers a.active { background-color: #f3882a; color: #f3882a; }
			.breadcrumb a:hover { color: #f3882a; }
			.tg-one-half .widget-title a:hover, .tg-one-third .widget-title a:hover, .tg-one-fourth .widget-title a:hover { color: #f3882a; }
			.pagination span { background-color: #f3882a; }
			.pagination a span:hover { color: #f3882a; border-color: .#f3882a; }
			.widget_testimonial .testimonial-post { border-color: #f3882a #EAEAEA #EAEAEA #EAEAEA; }
			.call-to-action-content-wrapper { border-color: #EAEAEA #EAEAEA #EAEAEA #f3882a; }
			.call-to-action-button { background-color: #f3882a; }
			#content .comments-area a.comment-permalink:hover { color: #f3882a; }
			.comments-area .comment-author-link a:hover { color: #f3882a; }
			.comments-area .comment-author-link span { background-color: #f3882a; }
			.comment .comment-reply-link:hover { color: #f3882a; }
			.nav-previous a:hover, .nav-next a:hover { color: #f3882a; }
			#wp-calendar #today { color: #f3882a; }
			.widget-title span { border-bottom: 2px solid #f3882a; }
			.footer-widgets-area a:hover { color: #f3882a !important; }
			.footer-socket-wrapper .copyright a:hover { color: #f3882a; }
			a#back-top:before { background-color: #f3882a; }
			.read-more, .more-link { color: #f3882a; }
			.post .entry-title a:hover, .page .entry-title a:hover { color: #f3882a; }
			.entry-meta .read-more-link { background-color: #f3882a; }
			.entry-meta a:hover, .type-page .entry-meta a:hover { color: #f3882a; }
			.single #content .tags a:hover { color: #f3882a; }
			.widget_testimonial .testimonial-icon:before { color: #f3882a; }
			a#scroll-up { background-color: #f3882a; }
			#search-form span { background-color: #f3882a; }
			.widget_featured_posts .tg-one-half .entry-title a:hover { color: #f3882a; }
			.woocommerce a.button, .woocommerce button.button, .woocommerce input.button, .woocommerce #respond input#submit, .woocommerce #content input.button, .woocommerce-page a.button, .woocommerce-page button.button, .woocommerce-page input.button, .woocommerce-page #respond input#submit, .woocommerce-page #content input.button { background-color: #f3882a; }
			.woocommerce a.button:hover,.woocommerce button.button:hover,.woocommerce input.button:hover,.woocommerce #respond input#submit:hover,.woocommerce #content input.button:hover,.woocommerce-page a.button:hover,.woocommerce-page button.button:hover,.woocommerce-page input.button:hover,.woocommerce-page #respond input#submit:hover,.woocommerce-page #content input.button:hover { background-color: #f3882a; } .main-navigation li, .small-menu li { font-family: "Raleway"; } #site-title a { font-size: 26px; } #site-description { font-size: 18px; } .main-navigation ul li a { font-size: 18px; } .main-navigation ul li ul li a { font-size: 14px; } #featured-slider .entry-title span  { font-size: 24px; } #featured-slider .entry-content p  { font-size: 14px; } #featured-slider .slider-read-more-button { font-size: 18px; } .header-post-title-class  { font-size: 18px; } .post .entry-title, .page .entry-title, .widget_featured_posts .tg-one-half .entry-title { font-size: 20px; } #secondary h3.widget-title, .widget_service_block .widget-title, .widget_featured_single_post .widget-title, .widget_testimonial .widget-title, .widget_recent_work .tg-one-half .widget-title, .widget_recent_work .tg-one-third .widget-title, .widget_recent_work .tg-one-fourth .widget-title { font-size: 24px; } #colophon .widget-title { font-size: 18px; } .widget_our_clients .widget-title, .widget_featured_posts .widget-title { font-size: 24px; } .comments-title, .comment-reply-title { font-size: 24px; } body, button, input, select, textarea, p, dl, .spacious-button, input[type="reset"], input[type="button"], input[type="submit"], button, .previous a, .next a, .widget_testimonial .testimonial-author span, .nav-previous a, .nav-next a, #respond h3#reply-title #cancel-comment-reply-link, #respond form input[type="text"],
#respond form textarea, #secondary .widget, .error-404 .widget { font-size: 14px; } .entry-meta { font-size: 12px; } .read-more, .more-link { font-size: 12px; } #colophon, #colophon p { font-size: 12px; } .main-navigation a { color: #ffffff; } .main-navigation ul li ul li a { color: #ffffff; } #featured-slider .slider-read-more-button { background-color: #f3882a; } .entry-meta a, .type-page .entry-meta a { color: #999999; } .entry-meta .read-more-link { background-color: #0b5ca3; } .read-more, .more-link { color: #0b5ca3; } .call-to-action-button  { background-color: #ffffff; } #colophon .widget-title   { color: #ffffff; } .footer-widgets-area { color: #ffffff; } .footer-widgets-wrapper { background-color: #ffffff; } .footer-socket-wrapper .copyright, .footer-socket-wrapper .copyright a { color: #ffffff; } #colophon .small-menu a { color: #ffffff; } .footer-socket-wrapper { background-color: #0b5ca3; }</style>
			<style type="text/css">
			#site-title,
		#site-description {
			position: absolute;
...
<aside id="cnss_widget-3" class="widget widget_cnss_widget"><table class="cnss-social-icon" style="width:111px" border="0" cellspacing="0" cellpadding="0"><tbody><tr><td style="width:37px"><a target="_blank" title="facebook" href="https://www.facebook.com/SEADDataNet"><img src="http://seadwp.sites.uofmhosting.net/wp-content/uploads/1403285144_facebook.png" border="0" width="32" height="32" alt="facebook"></a></td><td style="width:37px"><a target="_blank" title="twitter" href="https://twitter.com/SEADdatanet"><img src="http://seadwp.sites.uofmhosting.net/wp-content/uploads/1403285215_twitter.png" border="0" width="32" height="32" alt="twitter"></a></td><td style="width:37px"><a target="_blank" title="Slideshare" href="http://www.slideshare.net/SEADdatanet"><img src="http://seadwp.sites.uofmhosting.net/wp-content/uploads/1403285311_slidershare.png" border="0" width="32" height="32" alt="Slideshare"></a></td></tr></tbody></table></aside></div>
     ...
     <h1 class="menu-toggle">Menu</h1>
       <div class="menu-global-navigation-container"><ul id="menu-global-navigation" class="menunav-menu"><li id="menu-item-96" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-2 current_page_item menu-item-96"><a href="http://seadwp.sites.uofmhosting.net/">Home</a></li>
...
<li id="menu-item-244" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-244"><a href="http://sead.ncsa.illinois.edu/community/">Project Spaces</a></li>
...
<ul class="sub-menu">
	<li id="menu-item-247" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-247"><a href="http://sead-vivo.d2i.indiana.edu:8080/sead-vivo/people">People</a></li>
	<li id="menu-item-248" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-248"><a href="http://sead-vivo.d2i.indiana.edu:8080/sead-vivo/organizations">Organizations</a></li>
	<li id="menu-item-249" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-249"><a href="http://sead-vivo.d2i.indiana.edu:8080/sead-vivo/research">Research</a></li>

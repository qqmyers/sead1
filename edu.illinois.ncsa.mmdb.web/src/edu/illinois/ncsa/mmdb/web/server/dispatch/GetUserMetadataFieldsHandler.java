...
public class GetUserMetadataFieldsHandler implements ActionHandler<GetUserMetadataFields, GetUserMetadataFieldsResult> {

	Map<String,String> getUserMetadataFields() throws OperatorException {
	...
	public GetUserMetadataFieldsResult execute(GetUserMetadataFields arg0,
		...
		try {
			...
			for(Map.Entry<String,String> fl : getUserMetadataFields().entrySet()) {

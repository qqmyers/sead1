...
public class MimeMap {
	...
	public static String findCategory(String fileExt) {
		...
		fileExt = mimeMap.get(fileExt);
        if (fileExt.startsWith("image/")) {
            return "Image";
        } else if (fileExt.startsWith("video/")) {
            return "Video";
        } else if (fileExt.startsWith("audio/")) {
            return "Audio";
        } else if (fileExt.endsWith("x-tgif")) {
            return "3D";
        } else if (fileExt.startsWith("text/")) {
            return "Document";
        } else if (fileExt.endsWith("pdf")) {
            return "Document";
        } else if (fileExt.endsWith("word")) {
            return "Document";
        } else if (fileExt.endsWith("powerpoint")) {
            return "Document";
        } else if (fileExt.endsWith("excel")) {
            return "Document";
        } else {
            return "Other";
        }

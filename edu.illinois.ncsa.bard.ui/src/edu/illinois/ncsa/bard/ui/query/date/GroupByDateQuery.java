package edu.illinois.ncsa.bard.ui.query.date;
...
public class GroupByDateQuery extends FrameQuery
{
    public GroupByDateQuery( BardFrame frame )
    {
        super( frame );
    }
    ...
    public void execute() throws OperatorException
    {
        ...
        for ( Tuple<Resource> tuple : result ) {
            ...
            if ( g == null ) {
                ...
                DateMemberQuery query = new DateMemberQuery( frame, g );
                query.setTag( tag );
